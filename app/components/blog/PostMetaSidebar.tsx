        ...
        <aside className="space-y-3 text-sm">
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="text-emerald-400 font-medium capitalize">{post.category.replace("-", " ")}</p>
                </div>
            </div>
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-1">
                        {post.tags.map((tag) => (
                            <span key={tag} className="text-xs text-zinc-300 bg-white/5 border border-white/10 rounded-full px-2 py-0.5">
                                {tag}
                            </span>
                        ))}
                    </div>
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    <p className="text-zinc-500">Reading time</p>
                    <p className="text-white font-medium">{post.readingTime}</p>
                </div>
            </div>
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    ...
                    <button
                        onClick={copyLink}
                        className="text-white font-medium underline underline-offset-2 hover:text-emerald-400 transition-colors"
                    >
